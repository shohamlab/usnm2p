...
def apply_rolling_window(x, w, func=None, warn_oversize=True, pad='symmetric'):
    '''
    ...
    :param warn_oversize: whether to print warning message if window size is larger than input array.
    :param pad: padding mode (default = "symmetric") 
