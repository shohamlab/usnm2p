...
# @Last Modified time: 2025-08-07 14:24:07
...
OPT_POPSIZE = 15  # Default multiplier for total population size (only valid for differential evolution)
OPT_MAXITER = 5000  # Default number of iteration for global optimization algorithm
