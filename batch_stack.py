...
# @Last Modified time: 2022-08-16 16:45:17
...
from stackers import stack_trial_tifs
...
# Input directory for resampled data
ref_sr = 30.00  # Hz
target_sr = 3.56   # Hz
sr = StackResampler(ref_sr=ref_sr, target_sr=target_sr)
datadir = get_output_equivalent(rawdir, 'raw', f'{sr.rootcode}/{sr.code}')
...
for tif_folder in tif_folders:
    ...
    output_fpaths = stack_trial_tifs(tif_folder, overwrite=False)
